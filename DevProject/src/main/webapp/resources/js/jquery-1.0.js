...
function jQuery(a,c) {   //분석 $("#myDiv") 호출시 ,  a = myDiv , c = undefined

	// Shortcut for document ready (because $(document).each() is silly)
	// 인자 a가 함수이고, jQuery.fn.ready 가 참이면, #myDiv일 경우 a.constructor 는 String
	...
	// Watch for when a jQuery object is passed as the selector (a가 jquery 프로퍼티를 가지고 있는 객체라면)
	if ( a.jquery )
	...
	// If the context is global, return a new object - 분석 jQuery Function Object Create.
	if ( window == this )
